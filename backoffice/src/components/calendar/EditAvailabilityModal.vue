    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
      <div class="mt-3">
        ...
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-medium text-gray-900">Modifier la règle de disponibilité</h3>
          <button
            @click="$emit('close')"
...
watch(() => props.rule, (newRule) => {
  if (newRule) {
    form.dayOfWeek = newRule.dayOfWeek.toString()
    form.startTime = newRule.startTime
    form.endTime = newRule.endTime
    form.isActive = newRule.isActive
  }
}, { immediate: true })
