...
CREATE TABLE companies (
    ...
    settings JSONB DEFAULT '{}', -- Configuration spÃ©cifique Ã  l'entreprise
...
-- =============================================
-- TABLE: users (Utilisateurs liÃ©s aux entreprises)
-- =============================================
CREATE TABLE users (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    permissions JSONB DEFAULT '{}', -- Permissions spÃ©cifiques
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
-- =============================================
-- TABLE: persons (persons liÃ©s aux entreprises)
-- =============================================
CREATE TABLE persons (
    ...
    source VARCHAR(50), -- Comment le client nous a trouvÃ©
    tags TEXT[], -- Tags pour catÃ©goriser
    custom_fields JSONB DEFAULT '{}', -- Champs personnalisÃ©s par entreprise
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
-- =============================================
-- TABLE: products (Produits liÃ©s aux entreprises)
-- =============================================
CREATE TABLE products (
    ...
    tags TEXT[],
    custom_fields JSONB DEFAULT '{}', -- Champs personnalisÃ©s
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
-- =============================================
-- TABLE: quotes (Devis liÃ©s aux entreprises)
-- =============================================
CREATE TABLE quotes (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
    ...
    -- Contrainte unique numÃ©ro de devis par entreprise
...
-- =============================================
-- TABLE: invoices (Factures liÃ©es aux entreprises)
-- =============================================
CREATE TABLE invoices (
    ...
    -- Contrainte unique numÃ©ro de facture par entreprise
...
-- =============================================
-- TABLE: messages (Messages internes liÃ©s aux entreprises)
-- =============================================
...
-- Table pour stocker les identifiants de rÃ©seaux sociaux par entreprise
...
-- =============================================
-- TABLE: appointments (Rendez-vous liÃ©s aux entreprises)
-- =============================================
CREATE TABLE appointments (
    ...
    -- Contrainte pour Ã©viter les crÃ©neaux en double par user_id
...
-- =============================================
-- Tables emails (catÃ©gories et expÃ©diteurs)
-- =============================================
CREATE TABLE email_categories (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    name VARCHAR(255) NOT NULL,
    download_attachments BOOLEAN DEFAULT true,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
CREATE INDEX idx_email_categories_user_id ON email_categories(user_id);
...
CREATE INDEX idx_email_senders_user_id ON email_senders(user_id);
